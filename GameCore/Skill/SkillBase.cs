...
namespace GameCore.Skill
{
    ...
    public class SkillBase : ScriptableObject
    {
        ...
        public SkillBase RequiredPreSkill;    // 依赖的前置技能
        ...
        public void ReduceCoolingTime(int reduceSeconds)
        {
            if (reduceSeconds <= 0) return;
            CurrentCoolingTurns = Math.Max(0, CurrentCoolingTurns - reduceSeconds);
